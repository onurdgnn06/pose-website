...
.nut-range-container {
  ...
  position: relative;
  width: 100%;
  height: var(--nutui-range-height, 2px);
  align-items: center;
...
.nut-range {
  ...
  background-color: var(--nutui-range-inactive-color, var(--nutui-color-default));
  border-radius: 2px;
  flex: 1;
  cursor: pointer;
}
...
.nut-range-min, .nut-range-max {
  ...
  color: var(--nutui-range-color, var(--nutui-color-title));
  user-select: none;
}
.nut-range-bar {
  display: block;
...
.nut-range-button {
  ...
  background: var(--nutui-range-button-background, var(--nutui-color-text-dark));
  border-radius: 50%;
  box-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.15);
  border: var(--nutui-range-button-border, none);
  outline: none;
  align-items: center;
  top: 50%;
  left: 50%;
...
.nut-range-tick {
  ...
  left: 0px;
  border-radius: 6px;
  background: var(--nutui-range-inactive-color, var(--nutui-color-default));
}
...
.nut-range-vertical {
  width: var(--nutui-range-height, 2px);
