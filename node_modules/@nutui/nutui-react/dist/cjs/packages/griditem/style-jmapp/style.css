...
.nut-grid-item {
  ...
  color: var(--nutui-grid-item-text-color, var(--nutui-color-title));
  overflow: hidden;
}
.nut-grid-item-text {
  color: var(--nutui-grid-item-text-color, var(--nutui-color-title));
  font-size: var(--nutui-grid-item-text-font-size, var(--nutui-font-text-small));
...
.nut-grid-item-content {
  ...
  background: var(--nutui-grid-item-content-bg-color, #ffffff);
  border: 0 solid var(--nutui-grid-border-color, var(--nutui-color-border));
}
...
.nut-grid-item-content-surround {
  ...
  border-radius: var(--nutui-grid-item-border-radius, var(--nutui-radius-l));
}
