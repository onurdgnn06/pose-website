...
.nut-tabs-titles {
  ...
  overflow-x: auto;
  overflow-y: hidden;
  background: var(--nutui-tabs-titles-background-color, #ffffff);
...
.nut-tabs-titles-item-smile, .nut-tabs-titles-item-line {
  ...
  bottom: var(--nutui-tabs-line-bottom, 0);
  border-radius: var(--nutui-tabs-line-border-radius, 3px);
  opacity: var(--nutui-tabs-tab-line-opacity, 1);
  overflow: hidden;
}
.nut-tabs-titles-item-smile {
  bottom: var(--nutui-tabs-titles-item-smile-bottom, -10px);
}
...
.nut-tabs-titles-item-active .nut-icon {
  color: var(--nutui-tabs-titles-item-active-color, var(--nutui-color-primary));
}
.nut-tabs-titles-item-active .nut-tabs-titles-item-text {
  color: var(--nutui-tabs-titles-item-active-color, var(--nutui-color-primary));
  font-weight: var(--nutui-tabs-titles-item-active-font-weight, var(--nutui-font-weight-bold));
}
.nut-tabs-titles-item-active .nut-tabs-titles-item-line {
  overflow: unset;
  content: " ";
  width: var(--nutui-tabs-tab-line-width, 24px);
  height: var(--nutui-tabs-tab-line-height, 3px);
  background: var(--nutui-tabs-tab-line-color, var(--nutui-color-primary));
}
...
.nut-tabs-titles-simple .nut-tabs-titles-item-active .nut-icon {
  ...
  font-size: var(--nutui-tabs-titles-item-active-font-size, var(--nutui-font-text-large));
}
.nut-tabs-titles-card .nut-tabs-titles-item-active {
  font-weight: var(--nutui-font-weight-bold);
  background-color: #ffffff;
  border-radius: var(--nutui-radius-base) var(--nutui-radius-base) 0 0;
}
...
.nut-tabs-titles-button .nut-tabs-titles-item-active .nut-tabs-titles-item-text {
  ...
  color: var(--nutui-tabs-titles-item-active-color, var(--nutui-color-primary));
  border-radius: var(--nutui-tabs-button-border-radius, var(--nutui-radius-xs));
  font-weight: var(--nutui-font-weight-bold);
  background-color: var(--nutui-tabs-button-active-background-color, var(--nutui-color-primary-light-pressed));
  border: var(--nutui-tabs-button-active-border, 1px solid var(--nutui-color-primary));
}
...
.nut-tabs-titles-divider .nut-tabs-titles-item::after {
  ...
  height: 50%;
  width: 1px;
  background: var(--nutui-color-border);
...
.nut-tabs-vertical .nut-tabs-titles-item-active {
  background-color: var(--nutui-tabs-titles-item-active-background-color, var(--nutui-color-surface-2));
}
.nut-tabs-vertical .nut-tabs-titles-item-active .nut-tabs-titles-item-line {
  ...
  background: var(--nutui-tabs-vertical-tab-line-color, linear-gradient(180deg, var(--nutui-color-primary) 0%, var(--nutui-color-primary-light-pressed) 100%));
}
