...
.nut-price-symbol-large {
  font-size: var(--nutui-price-symbol-large-size, 18px);
}
.nut-price-symbol-normal {
  font-size: var(--nutui-price-symbol-normal-size, 14px);
}
.nut-price-symbol-small {
  font-size: var(--nutui-price-symbol-small-size, 10px);
}
...
.nut-price-integer-large {
  font-size: var(--nutui-price-integer-large-size, 24px);
}
...
.nut-price-decimal-large {
  font-size: var(--nutui-price-decimal-large-size, 18px);
}
.nut-price-decimal-normal {
  font-size: var(--nutui-price-decimal-normal-size, 14px);
}
.nut-price-decimal-small {
  font-size: var(--nutui-price-decimal-small-size, 10px);
}
.nut-price-line {
