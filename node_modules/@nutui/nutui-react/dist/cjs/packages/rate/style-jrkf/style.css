...
.nut-rate-item-icon .nut-icon {
  color: var(--nutui-rate-icon-color, var(--nutui-color-primary, #ff6666));
}
...
.nut-rtl .nut-rate-item-small {
  margin-right: calc(var(--nutui-rate-item-margin, 14px) - 2px);
}
...
.nut-rtl .nut-rate-score-small {
  padding-right: calc(var(--nutui-rate-item-margin, 14px) - 2px);
}