...
.nut-form-item-body-slots .nut-input-text {
  font-size: var(--nutui-form-item-body-font-size, var(--nutui-font-text));
...
.nut-form-item-body-tips {
  ...
  font-size: var(--nutui-form-item-tip-font-size, var(--nutui-font-text-xs));
  color: var(--nutui-form-item-error-message-color, var(--nutui-color-primary, #ff6666));
}
