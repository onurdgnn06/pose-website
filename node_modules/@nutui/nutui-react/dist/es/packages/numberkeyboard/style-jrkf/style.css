...
.nut-numberkeyboard-header-close {
  ...
  color: var(--nutui-numberkeyboard-header-close-color, var(--nutui-color-text));
...
.nut-numberkeyboard-body-wrapper {
  ...
  padding: 0 6px 6px 0;
  background-color: var(--nutui-numberkeyboard-wrapper-background-color, var(--nutui-color-surface-1));
}
.nut-numberkeyboard-body-wrapper .key {
  ...
  font-size: var(--nutui-numberkeyboard-key-font-size, var(--nutui-font-h2));
  line-height: var(--nutui-numberkeyboard-key-line-height, 1.5);
  background-color: var(--nutui-numberkeyboard-key-background-color, #fff);
  color: var(--nutui-numberkeyboard-key-color, var(--nutui-color-text));
  border-radius: var(--nutui-numberkeyboard-key-border-radius, var(--nutui-radius-base));
...
.nut-numberkeyboard-sidebar .nut-numberkeyboard-body-wrapper .confirm {
  font-size: var(--nutui-numberkeyboard-key-confirm-font-size, var(--nutui-font-text-large));
  color: var(--nutui-numberkeyboard-key-confirm-color, #fff);
  background-color: var(--nutui-numberkeyboard-key-confirm-background-color, var(--nutui-color-primary, #ff6666));
}
