...
.nut-menu-container-content {
  ...
  display: flex;
  flex-wrap: wrap;
  background: var(--nutui-menu-content-background-color, var(--nutui-color-surface-2));
}
...
.nut-menu-container-item.active {
  font-weight: var(--nutui-menu-item-active-font-weight, var(--nutui-font-weight-bold));
