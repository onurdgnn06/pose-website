...
.nut-noticebar .nut-noticebar-box {
  ...
  padding: var(--nutui-noticebar-box-padding, var(--nutui-spacing-s) var(--nutui-spacing-l));
  font-size: var(--nutui-noticebar-font-size, var(--nutui-font-text-small));
  background: var(--nutui-noticebar-background, rgb(251, 248, 220));
  color: var(--nutui-noticebar-color, #d9500b);
  border-radius: var(--nutui-noticebar-border-radius, 8px);
}
.nut-noticebar .nut-noticebar-box-wrapable, .nut-noticebar .nut-noticebar-box-center {
  height: auto;
  padding: var(--nutui-noticebar-wrapable-padding, 16px);
}
